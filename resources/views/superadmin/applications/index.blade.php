        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-800">
                    @tr('Business Applications')
                </h1>
                <p class="text-sm text-slate-500">
                    @tr('Review, accept, reject, or request additional documents for Business Applications.')
                </p>
            </div>
            ...
            <div class="inline-flex rounded-xl border border-slate-200 bg-white overflow-hidden text-xs sm:text-sm">
                @php
                    $statuses = [
                        ...
                        'interpolation' => tr('Pending Review'),
                    ];
                @endphp
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3">
                                @php
                                    ...
                                    $stColor = $statusColors[$app->status] ?? 'bg-slate-50 text-slate-700 ring-slate-200';
                                @endphp
                                <span
